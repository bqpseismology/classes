...
if ifig==1
    ...
    if iprint==1, print(gcf,'-depsc',sprintf('%sgenlsq_mprior_f%i',pdir,iforward)); end
    ...
    orient tall, wysiwyg
    if iprint==1, print(gcf,'-depsc',sprintf('%sgenlsq_CD1_f%i',pdir,iforward)); end
    ...
    if iprint==1, print(gcf,'-depsc',sprintf('%sgenlsq_CD2b_f%i',pdir,iforward)); end
end
...
if ifig==1
    ...
    if iprint==1, print(gcf,'-depsc',sprintf('%sgenlsq_converge_%s_f%i',pdir,stmethod,iforward)); end
end
...
if ifig==1
    ...
    if iprint==1, print(gcf,'-depsc',sprintf('%sgenlsq_mpost2_hist_f%i',pdir,iforward)); end
