...
display(['Displaying the resolution matrix for the discrepancy principle'...
    ' (fig. 7)'])
...
display(['Displaying the discrepancy principle predicted model with error'...
    ' bars (fig. 8)'])
...
display(['Displaying the recovered model from the noisy data associated'...
