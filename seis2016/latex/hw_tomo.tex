...
(Note \footnote{See the section in the math review homework solutions, ``ASIDE: the natural log function used to express tomographic models.''})
...
%
From the class notes (\verb+taylor.pdf+), the ray theory traveltime perturbation for the $i$th source-receiver combination is given by
%
\begin{equation}
