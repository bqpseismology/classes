...
Assigned: February 8, 2016 --- Due: February 15, 2016 \\
Last compiled: \today
\end{spacing}
...
\item (0.0) Run \verb+CAN_response_template.m+. The first time you run this, it will compute and save the Fourier transform of a seismogram. This will take about 5 minutes.

Note: make sure that you run this from your \verb+seis2014+ directory, since the file will be saved there.
