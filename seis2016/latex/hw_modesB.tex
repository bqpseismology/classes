...
\subsection*{Problem 1 (1.5). Setup}
...
\subsection*{Problem 2 (8.5). Implementation}
...
\item (3.5) Adapt the four scripts from the modes homework to solve \refEq{rODEs}.
...
\item (1.0) Compute the displacement and stress eigenfunctions (show plots) and values (list in table) of wavenumber for the fundamental mode, $k_0$ ($n=0$), for periods of 120, 80, 50, 25, 10, and 6 seconds.

\begin{spacing}{1.5}
\begin{tabular}{r|r|r}
\hline\hline
period, s & frequency, mHz & wavenumber, 1/m  \\ \hline\hline
120 & & \\ \hline
80 & & \\ \hline
50 & &  \\ \hline
25 & & \\ \hline
...
(b) Dispersion plot for Love waves in a layer-over-halfspace. The dots are not discrete modes; one should think of the solution space as a set of curves (\ie connect the colored dots).
The model is described listed in Problem~1-\ref{prob:model1}.
\label{fig:dots}
}}
\end{figure}
