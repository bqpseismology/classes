...
%Assigned: January 30, 2014 --- Due: February 6, 2014 \\
Last compiled: \today
\end{spacing}
...
\item (2.4) See \refFig{fig:cmt}. In Problem 1, you used the expression $\br = \bU(\rotvec,\rotangB)\br_0$. Here you want to write similar abstract expressions for $\bK$, $\bN$, $\bS$. Please also describe each expression in words.
%
\begin{enumerate}
