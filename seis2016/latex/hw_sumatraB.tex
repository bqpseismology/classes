...
%
\begin{enumerate}
\item (0.4) Set \verb+iload = 0+ in \verb+sumatra_modes_template.m+, then modify \verb+ipick+ (or use \verb+wkeep.m+) and plot the stations you selected in \verb+lab_sumatra.pdf+. To save paper, use something like a $5 \times 4$ subplot.
...
\item Qualitatively, describe the meaning of this spectrum, \eg what is the physical explanation for the spikes? It may be helpful to recall the modes homework.
\end{enumerate}
%
...
\item (0.5) Analyze \snl{0}{2} as a function of latitude.
...
\centering
\begin{tabular}{cc}
(a) & \includegraphics[width=11cm]{modes_toroidal} \\
(b) & \includegraphics[width=11cm]{modes_spheroidal}
\end{tabular}
\caption[]
{{
