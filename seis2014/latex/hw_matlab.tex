...
%
\begin{enumerate}
\item Using the frequency-magnitude relation (\refeq{GRd}), show that the incremental distribution can be written as
%
\begin{equation}
...
%
\begin{enumerate}
\item Starting from \refEq{GRd}, derive the analytical formula for $d N/ d M$.

\item Using this, as well as the mathematical definition of a derivative, derive an expression analagous to \refEq{inc} that is valid for small bin widths, $\Delta M \ll 1$. List the expression for $\Delta a$
