...
\begin{figure}[h]
\centering
\includegraphics[width=12cm]{optimhw_fig02.eps}
...
\item List the dimensions of the quantities in \refTab{tab:vars}, assuming $M$ model parameters and $N$ observations.
